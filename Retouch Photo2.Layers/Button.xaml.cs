...
namespace Retouch_Photo2.Layers
{
    ...
    public sealed partial class Button : UserControl
    {
        ...
        public event TappedEventHandler RootGridTapped;
        ...
        public Button()
        {
            ...
            this.RootGrid.Tapped += (s, e) => this.RootGridTapped?.Invoke(s, e);
            this.IsVisualButton.Tapped += (s, e) =>
            {
                this.IsVisualButtonTapped?.Invoke(s, e);
                e.Handled = true;
            };
            this.CheckBox.Tapped += (s, e) =>
            {
                this.CheckBoxTapped?.Invoke(s, e);
                e.Handled = true;
            };
        }
    }
