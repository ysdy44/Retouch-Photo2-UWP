...
namespace FanKit.Win2Ds
{
    ...
    public class CurveNodes
    {
        ...
        public CurveNodes() : this(new List<Node>())
        {
        }
        public CurveNodes(List<Node> list)
        {
            this.Nodes = list;
        }
        ...
        public void Interpolation()
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                {
                    ChooseMode = NodeChooseMode.Vector
                };
    ...
    public class Node:FanKit.Transformers.ICacheTransform
    {
        /// <summary> Vector. </summary>
        public Vector2 Vector;
        /// <summary> <see cref = "Node.Vector" />'s old cache. </summary>
        public Vector2 OldVector;

        /// <summary> The specified control point on left. </summary>
        public Vector2 LeftControl;
        /// <summary> <see cref = "Node.LeftControl" />'s old cache. </summary>
        public Vector2 OldLeftControl;

        /// <summary> The specified control point on right. </summary>
        public Vector2 RightControl;
        /// <summary> <see cref = "Node.RightControl" />'s old cache. </summary>
        public Vector2 OldRightControl;
        ...
        public void CacheTransform()
        {
            ...
            this.OldLeftControl = this.LeftControl ;
            this.OldRightControl = this.RightControl;
        }
        public void TransformAdd(Vector2 vector)
        {
            this.Vector = this.OldVector + vector;
            this.LeftControl = this.OldLeftControl + vector;
            this.RightControl = this.OldRightControl + vector;
        }
        public void TransformMultiplies(Matrix3x2 matrix)
        {
            this.Vector = Vector2.Transform(this.OldVector, matrix);
            this.LeftControl = Vector2.Transform(this.OldLeftControl, matrix);
            this.RightControl = Vector2.Transform(this.OldRightControl, matrix);
        }
        ...
        {
            if (this.Vector.X < left) return false;
            if (this.Vector.Y < top) return false;
            if (this.Vector.X > right) return false;
            if (this.Vector.Y > bottom) return false;
