...
namespace Retouch_Photo2.Tools.Models
{
    ...
    public partial class GeometryHeartPage : Page
    {
        ...
        /// <summary> Gets or sets <see cref = "GeometryHeartPage" />'s IsOpen. </summary>
        public bool IsOpen
        {
            get => (bool)base.GetValue(IsOpenProperty);
            set => base.SetValue(IsOpenProperty, value);
        }
        /// <summary> Identifies the <see cref = "GeometryHeartPage.IsOpen" /> dependency property. </summary>
        public static readonly DependencyProperty IsOpenProperty = DependencyProperty.Register(nameof(IsOpen), typeof(bool), typeof(GeometryHeartPage), new PropertyMetadata(false));
