...
namespace Retouch_Photo2.Tools
{
    ...
    public interface ITransformerTool
    {
        ...
        bool Starting(Vector2 point);
        /// <summary>
        /// Occurs when the operation begins. 
        /// </summary>
        /// <param name="startingPoint"> The starting pointer. </param>
        /// <param name="point"> The pointer. </param>
        /// <param name="isSetTransformerMode"> Do you want to reset the transformer mode? </param>
        bool Started(Vector2 startingPoint, Vector2 point, bool isSetTransformerMode = true);
        /// <summary>
