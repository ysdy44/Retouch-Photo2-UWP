...
namespace Retouch_Photo2.Brushs
{
    ...
    public sealed partial class FillOrStrokeControl : UserControl
    {
        ...
        private void ConstructStrings()
        {
            ...
            this.FillButton.Text = resource.GetString("/ToolElements/Fill");
            this.FillButton.CenterContent = new FillIcon();
            ...
            this.StrokeButton.Text = resource.GetString("/ToolElements/Stroke");
            this.StrokeButton.CenterContent = new StrokeIcon();
