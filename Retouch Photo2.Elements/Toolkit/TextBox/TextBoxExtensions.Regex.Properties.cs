...
namespace Microsoft.Toolkit.Uwp.UI
{
    ...
    {
        /// <summary>
        /// Identifies the Default attached dependency property.
        /// </summary>
        public static readonly DependencyProperty DefaultProperty = DependencyProperty.RegisterAttached("Default", typeof(string), typeof(TextBoxExtensions), new PropertyMetadata(0.ToString()));
        ...
        /// <summary>
        /// Gets the value of the TextBoxRegex.Default XAML attached property from the specified TextBox.
        /// </summary>
        ...
        public static string GetDefault(TextBox textBox)
        {
            return (string)textBox.GetValue(RegexProperty);
        }

        /// <summary>
        /// Sets the value of the TextBoxRegex.Default XAML attached property for a target TextBox.
        /// </summary>
        /// <param name="textBox">The TextBox to set the regular expression on</param>
        /// <param name="value">Default value</param>
        public static void SetDefault(TextBox textBox, string value)
        {
