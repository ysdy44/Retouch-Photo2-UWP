...
namespace Retouch_Photo2.Elements
{
    ...
    /// </summary>
    public partial class VisualUIElementHelper
    {
        ...
        {
            return VisualUIElementHelper.GetBoundPostion
            (
                postion,
                element.ActualWidth,
        ...
        public static Point GetFlyoutPostion(FrameworkElement button, FrameworkElement layout, FlyoutPlacementMode placement)
        {
            ...
            return VisualUIElementHelper.GetFlyoutPostion(
                VisualUIElementHelper.GetVisualPostion(button),
