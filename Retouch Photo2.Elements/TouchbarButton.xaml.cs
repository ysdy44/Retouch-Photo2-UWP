...
namespace Retouch_Photo2.Elements
{
    public sealed partial class TouchbarButton : UserControl
    {
        ...
        public static readonly DependencyProperty IsCheckedProperty = DependencyProperty.Register(nameof(IsChecked), typeof(bool), typeof(OnOffSwitch), new PropertyMetadata(false));
