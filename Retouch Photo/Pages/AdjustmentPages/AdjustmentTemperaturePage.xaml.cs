...
{
    public sealed partial class AdjustmentTemperaturePage : Page
    {
        ...
        {
            AdjustmentTemperaturePage con = (AdjustmentTemperaturePage)sender;
        ...
        public AdjustmentTemperaturePage()
        {
