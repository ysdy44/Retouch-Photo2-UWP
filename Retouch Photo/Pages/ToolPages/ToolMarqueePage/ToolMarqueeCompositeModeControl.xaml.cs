...
{
    public sealed partial class ToolMarqueeCompositeModeControl : UserControl
    {
        ...
        public static readonly DependencyProperty ModeProperty = DependencyProperty.Register(nameof(Mode), typeof(MarqueeCompositeMode), typeof(ToolMarqueeCompositeModeControl), new PropertyMetadata(MarqueeCompositeMode.New, (sender, e) =>
        {
            ToolMarqueeCompositeModeControl con = (ToolMarqueeCompositeModeControl)sender;
        ...
        public ToolMarqueeCompositeModeControl()
        {
