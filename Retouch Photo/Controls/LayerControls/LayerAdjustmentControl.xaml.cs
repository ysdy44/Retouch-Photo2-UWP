...
namespace Retouch_Photo.Controls.LayerControls
{
    public sealed partial class LayerAdjustmentControl : UserControl
    {
        ...
        public static readonly DependencyProperty AdjustmentProperty = DependencyProperty.Register(nameof(Adjustment), typeof(Adjustment), typeof(LayerAdjustmentControl), new PropertyMetadata(null));
